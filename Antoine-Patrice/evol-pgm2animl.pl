require "toutesRoutinesCovid.pl";
require "pgm1-anim.pl";
...
$deltajour=3; # ICIDELTAJOUR un jour sur deltajour représenté
$numerojourdepart=1; # commence à 1: 0="dateen"

$inversedelai=2; #ICIINVERSEDELAI X -> changements toutes les 1/X secondes
